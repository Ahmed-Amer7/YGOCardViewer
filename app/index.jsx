      ...
      <View>
        ...
        <View className="h-full bg-white p-4">
          ...
          <View className="flex flex-row gap-6 items-center h-24">
            ...
            <Text className="border p-2 rounded-sm text-white bg-[#7d3e12]">02</Text>
            <Text className="border p-2 rounded-sm text-white bg-[#7d3e12]">03</Text>
          </View>
          <View className="h-full bg-[#f8f9fb] rounded-lg border border-[#dddfde]">
            <Card />
          </View>
        </View>
      </View>
